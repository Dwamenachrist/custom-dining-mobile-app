...
type NotificationType = 'All' | 'Orders' | 'Promotions' | 'Reminders';
...
const TABS: NotificationType[] = ['All', 'Orders', 'Promotions', 'Reminders'];
...
export default function CustomerNotificationsScreen() {
  ...
  const filteredNotifications = selectedTab === 'All' 
    ...
    : CUSTOMER_NOTIFICATIONS.filter(n => n.type === selectedTab);
